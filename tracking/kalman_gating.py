...
def noisy():
    ...
    data = tr.conversion(data_[data_[:, 0].argsort()][:900])
...
if __name__ == "__main__":
    ...
    plt.plot(t2, corrections[:, 0], c="white")
    plt.scatter(track1[:, 0], track1[:, 1], c='b')
    plt.scatter(track2[:, 0], track2[:, 1], c='b')
    # plt.scatter(track3[:, 0], track3[:, 1], c='b')
    plt.scatter(t1, exact_values[:, 0], c="orange", alpha=0.1)
    plt.title("x")
    plt.show()
    plt.plot(t2, corrections[:, 1], c="white")
    plt.scatter(track1[:, 0], track1[:, 2], c='b')
    plt.scatter(track2[:, 0], track2[:, 2], c='b')
    # plt.scatter(track3[:, 0], track3[:, 2], c='b')
    plt.scatter(t1, exact_values[:, 1], c="orange", alpha=0.1)
    plt.title("y")
    plt.show()
    plt.plot(t2, corrections[:, 2], c="white")
    plt.scatter(track1[:, 0], track1[:, 3], c='b')
    plt.scatter(track2[:, 0], track2[:, 3], c='b')
    # plt.scatter(track3[:, 0], track3[:, 3], c='b')
    plt.scatter(t1, exact_values[:, 2], c="orange", alpha=0.1)
    plt.title("z")
    plt.show()
